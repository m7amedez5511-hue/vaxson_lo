...
export const signJwt = (userId, secretKey, issuer = null, params = null) => {
    return new Promise((resolve, reject) => {
        ...
        const options = {
            expiresIn: (secretKey == 'ACCESS_TOKEN_SECRET') ? (process.env.NODE_ENV === 'dev' ? JWT_CONFIG.REFRESH_TOKEN_EXPIRE_IN : JWT_CONFIG.ACCESS_TOKEN_EXPIRE_IN) : JWT_CONFIG.REFRESH_TOKEN_EXPIRE_IN,
            audience: `${userId}`,
        }
